...
// Pagination
$jmlHalamanPerData = 5;
$jumlahData = count(query("SELECT * FROM user_barber"));
...
$member = query("SELECT * FROM user_barber LIMIT $awalData, $jmlHalamanPerData");
            ...
            <tbody class="text">
              ...
              <?php foreach ($member as $row) : ?>
                <tr>
                  ...
                  <td><?= $row["barber_jenis_kelamin"]; ?></td>
                  <td><?= $row["barber_email"]; ?></td>
                  <td><?= $row["barber_no_handphone"]; ?></td>
                  <td>
                    <a href="./controller/hapusMember.php?id=<?= $row["barber_id_user"]; ?>" class="btn btn-danger">Hapus</a>
                  </td>
                </tr>
                <?php $i++; ?>
              <?php endforeach; ?>
