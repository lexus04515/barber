...
// Pagination
$jmlHalamanPerData = 3;
$jumlahData = count(query("SELECT booking_barber.barber_id_booking,user_barber.barber_nama_lengkap,booking_barber.barber_tanggal_pesan,booking_barber.barber_jam_mulai,booking_barber.barber_lama_booking,booking_barber.barber_total,bayar_barber.barber_bukti,bayar_barber.barber_konfirmasi
FROM booking_barber
...
FROM booking_barber
JOIN user_barber ON booking_barber.barber_id_user = user_barber.barber_id_user
JOIN bayar_barber ON booking_barber.barber_id_booking = bayar_barber.barber_id_booking LIMIT $awalData, $jmlHalamanPerData");
            ...
            <?php foreach ($pesan as $row) : ?>
              <tr>
                ...
                <td>
                  ...
                  if ($row["barber_konfirmasi"] == "Terkonfirmasi") {
                    // tampilkan tombol Bayar dan Hapus
                    echo '';
                  } else {
                    // tampilkan tombol Detail
                    echo ' <button type="button" class="btn btn-inti" data-bs-toggle="modal" data-bs-target="#konfirmasiModal' . $id_booking . '">
                    Konfir
                  </button>
                  <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapusModal' . $id_booking . '">
                    Hapus
                  </button>
                  ';
                  }
              ...
              <!-- Modal Konfirmasi -->
              <div class="modal fade" id="konfirmasiModal<?= $row["barber_id_booking"]; ?>" tabindex="-1" aria-labelledby="konfirmasiModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="konfirmasiModalLabel">Konfirmasi Pesanan <?= $row["barber_nama_lengkap"]; ?></h5>
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="./controller/konfirmasiPesan.php?id=<?= $row["barber_id_booking"]; ?>" class="btn btn-primary">Konfirmasi</a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <!-- Modal Hapus -->
              <div class="modal fade" id="hapusModal<?= $row["barber_id_booking"]; ?>" tabindex="-1" aria-labelledby="konfirmasiModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title" id="hapusModalLabel">Hapus Pesanan <?= $row["barber_nama_lengkap"]; ?></h5>
                      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                    ...
                    <div class="modal-footer">
                      <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Tutup</button>
                      <a href="./controller/hapusPesan.php?id=<?= $row["barber_id_booking"]; ?>" class="btn btn-danger">Hapus</a>
                    </div>
                  </div>
                </div>
              </div>
