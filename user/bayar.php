...
// Pagination
$jmlHalamanPerData = 5;
$jumlahData = count(query("SELECT booking_barber.*, layanan_barber.barber_nama, bayar_barber.barber_bukti, bayar_barber.barber_konfirmasi
FROM booking_barber
JOIN layanan_barber ON booking_barber.barber_id_layanan = layanan_barber.barber_id_layanan
left JOIN bayar_barber ON booking_barber.barber_id_booking = bayar_barber.barber_id_booking
WHERE booking_barber.barber_id_user = '$id_user'"));
...
$booking_barber = query("SELECT booking_barber.*, layanan_barber.barber_nama, bayar_barber.barber_bukti, bayar_barber.barber_konfirmasi
FROM booking_barber
JOIN layanan_barber ON booking_barber.barber_id_layanan = layanan_barber.barber_id_layanan
left JOIN bayar_barber ON booking_barber.barber_id_booking = bayar_barber.barber_id_booking
WHERE booking_barber.barber_id_user = '$id_user' LIMIT $awalData, $jmlHalamanPerData");
// Pagination
...
<body>
          ...
          <div class="modal-body">
            <div class="row justify-content-center align-items-center">
              ...
              <div class="col">
                ...
                <div class="mb-3">
                  <label for="barber_jenis_kelamin" class="form-label">Jenis Kelamin</label>
                  <select class="form-control" id="barber_jenis_kelamin" name="barber_jenis_kelamin" required>
                    <option value="Laki-laki" <?php if ($profil['barber_jenis_kelamin'] == 'Laki-laki') echo 'selected'; ?>>Laki-laki</option>
                    <option value="Perempuan" <?if ($profil['barber_jenis_kelamin'] == 'Perempuan') echo 'selected'; ?>>Perempuan</option>
                  </select>
              </div>
              </div>
              <div class="col">
  ...
  <section class="layanan_barber mb-5" id="layanan_barber">
    <div class="container-fluid">

      <h2 class="text-head"><span>Riwayat</span> Pesanan </h2>
      <form action="" method="post" enctype="multipart/form-data" class="px-4">
        <table class="table my-5">
          ...
          <tbody>
            <?php $i = 1; ?>
            <?php foreach ($booking_barber as $row) : ?>
              <tr>
                <th scope="row"><?= $i++; ?></th>
                ...
                <td>
                  <?php
                  $id_booking = $row["barber_id_booking"];
                  if ($row["barber_konfirmasi"] == "Sudah Bayar" || $row["barber_konfirmasi"] == "Terkonfirmasi") {
                    // tampilkan tombol Bayar dan Hapus
                    echo '<button type="button" class="btn btn-info" data-bs-toggle="modal" data-bs-target="#detailModal' . $row["barber_id_booking"] . '">Detail</button> ';
                  } else {
                    // tampilkan tombol Detail
                    echo '<button type="button" class="btn btn-inti" data-bs-toggle="modal" data-bs-target="#bayarModal' . $row["barber_id_booking"] . '">Bayar</button>
<a href="" data-bs-toggle="modal" data-bs-target="#hapusModal' . $row["barber_id_booking"] . '" class="btn btn-danger">Hapus</a>';
                  }
                  ?>
                  ...
                  <div class="modal fade" id="bayarModal<?= $row["barber_id_booking"] ?>" tabindex="-1" role="dialog" aria-labelledby="bayarModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered">
                      <div class="modal-content">
                        ...
                        <form action="" method="post" enctype="multipart/form-data">
                          <input type="hidden" name="barber_id_booking" value="<?= $row["barber_id_booking"]; ?>">
                          <div class="modal-body">
                            <!-- konten form modal -->
                            <div class="row justify-content-center align-items-center">
                              <div class="col">
                              ...
                              <div class="col">
                                <div class="mb-3">
                                  ...
                                  <input type="text" name="jam_mulai" class="form-control" id="exampleInputPassword1" value="<?= $row["barber_lama_booking"]; ?>" disabled>
                                </div>
                                <div class="mb-3">
                                  <label for="exampleInputPassword1" class="form-label">Harga</label>
                                  <input type="number" name="barber_harga" class="form-control" id="exampleInputPassword1" value="<?= $row["barber_harga"]; ?>" disabled>
                                </div>
                              </div>
                              ...
                              <div class="mt-3">
                                <label for="exampleInputPassword1" class="form-label">Transfer ke : BCA 0812345678 a/n Luthfi</label>
                              </div>
                              <div class="mt-3">
                          ...
                          <div class="modal-footer">
                            <button type="submit" class="btn btn-inti" name="bayar_barber" id="bayar_barber">Bayar</button>
                          </div>
                        </form>
                      </div>
                    </div>
                      ...
                      <div class="modal-content">
                        ...
                        <form action="" method="post">
                          <div class="modal-body">
                            ...
                            <div class="row justify-content-center align-items-center">
                              <div class="mb-3">
                                <img src="../img/<?= $row["barber_bukti"]; ?>" alt="gambar layanan_barber" class="img-fluid">
                              </div>
                              <div class="col">
                                <div class="mb-3">
                                  <label for="exampleInputPassword1" class="form-label">Tanggal Booking</label>
